...
#define clouds_bn_gfxTilesLen 3520
extern const bn::tile clouds_bn_gfxTiles[110];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item clouds(
            regular_bg_tiles_item(span<const tile>(clouds_bn_gfxTiles, 110), bpp_mode::BPP_4, compression_type::NONE), 
